...
using System.Net;
using System.Text;
using InterviewProject.Translators;
    ...
    public class NotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text")] Note note)
        {
            if (ModelState.IsValid)
            {
                ...
                _context.Add(note);
                TranslatorAPIUrl translatorAPIUrl = new(); 

                note.TextTransalted = TranslatorLanguage.GetTranslateText(note.Text, translatorAPIUrl.Leetspeak);
